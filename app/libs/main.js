...
function editors(){
	tinymce.init({
		...
		menubar: '',
		plugins: ['advlist', 'code', 'autolink', 'lists', 'link', 'anchor', 'pagebreak', 'image ', 'table'],
		toolbar: 'code undo redo | styles | bold italic forecolor backcolor image | ' +
				'alignleft aligncenter alignright alignjustify | ' +
				'bullist numlist checklist outdent indent | table removeformat link hr',
	});
}
